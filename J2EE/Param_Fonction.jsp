...
<head>
<title><bean:message key="fonc.type" /></title>
</head>
...
<br/>
<b><bean:message key="fonc.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_fonction.do?action=ajout">
	<lay:panel align="center" key="ajout.fonc" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_fonc"/>  </td>
				<td align="left"><html:text name="fonction" property="id_fonction" size="5" maxlength="5" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_fonc"/>  </td>
				<td align="left"><html:text  name="fonction" property="libelle_fonction" size="30" maxlength="30"  styleId="lib"></html:text></td>
...
<html:form action="gestion_fonction.do?action=edit">
	<lay:panel align="center" key="edit.fonc" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_fonc"/>  </td>
				<td align="left"><html:text name="fonction" property="id_fonction" readonly="true" size="5" maxlength="5"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<html:button styleId="b1"  onclick="document.location.href='gestion_fonction.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
...
<logic:present name="type_fonction" >
<lay:pager maxPageItems="20" > 
<lay:collection name="type_fonction" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_fonc">
<lay:collectionItem  property="id_fonction"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_fonc">
<lay:collectionItem    property="libelle_fonction" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_fonction.do?action=modif&id=" paramId="id" param="id_fonction"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_fonction"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_fonc"/></td>
...
lien=SortUtil.getURLForCollection("id_fonction",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_fonction",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typfonc"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libfonc"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_fonction.do?action=supp&id='+document.getElementById('cd').value}
