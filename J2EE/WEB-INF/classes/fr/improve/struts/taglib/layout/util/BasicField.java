...
public class BasicField implements FieldInterface {
	...
	public void doEndField(StringBuffer in_buffer, AbstractLayoutFieldTag in_tag, Object in_value) throws JspException{
		...
		if (in_tag.isRequired() && !lc_valueSet) {
			in_buffer.append("<img name=\"" + lc_property + "required\" src=\"" + lc_skin.getImageDirectory(lc_pageContext.getRequest()) + "/ast.gif\" alt=\"required\">");
		} else {
			in_buffer.append("<img name=\"" + lc_property + "required\" src=\"" + lc_skin.getImageDirectory(lc_pageContext.getRequest()) + "/clearpixel.gif\" alt=\"required\">");
		}
