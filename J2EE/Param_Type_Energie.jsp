...
<head>
<title><bean:message key="energie.type" /></title>
</head>
...
<br/>
<b><bean:message key="energie.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_energie.do?action=ajout">
	<lay:panel align="center" key="ajout.energie" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_energie"/>  </td>
				<td align="left"><html:text name="energie" property="id_energie" size="2" maxlength="2" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_energie"/>  </td>
				<td align="left"><html:text  name="energie" property="libelle_energie" size="20" maxlength="20"  styleId="lib"></html:text></td>
...
<html:form action="gestion_energie.do?action=edit">
	<lay:panel align="center" key="edit.energie" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_energie"/>  </td>
				<td align="left"><html:text name="energie" property="id_energie" readonly="true" size="2" maxlength="2"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<html:button styleId="b1" onclick="document.location.href='gestion_energie.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
				</td>
...
<logic:present name="liste_energie" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_energie" id="ji"  styleClass="FORM" styleClass2="FORM2" >
<lay:collectionTitle title="code_energie">
<lay:collectionItem  property="id_energie"  ></lay:collectionItem>
</lay:collectionTitle>
<lay:collectionTitle title="libelle_energie">
<lay:collectionItem    property="libelle_energie" ></lay:collectionItem>
</lay:collectionTitle>
<lay:collectionItem title=" " href="gestion_energie.do?action=modif&id=" paramId="id" param="id_energie"><img src="config/modif.png" alt="modifier" border="0"  /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_energie"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_energie"/></td>
...
lien=SortUtil.getURLForCollection("id_energie",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_energie",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typenergie"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libenergie"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_energie.do?action=supp&id='+document.getElementById('cd').value}
...
function envoie(id)
{
if(id=='id_energie_lien')
document.location.href='<%=lien%>'
if(id=='lib_energie_lien')
