...
public class LayoutUtils {
	...
	public static List retrieveErrors(PageContext pageContext, String property)
		throws JspException {
		return retrieveErrors(pageContext, Globals.MESSAGES_KEY, property);		
	}

	/**
	 * Returns the errors associated with an input field.
	 */
	public static List retrieveErrors(PageContext pageContext, String bundle, String property)
		throws JspException {
	 ...
	 */
	public static String computeURL(PageContext in_pageContext, String in_forward, String in_url, String in_page, String in_action, String in_module, Map in_params, String in_anchor, boolean in_redirect, String in_target) throws JspException {
	 ...
	 * includes call to the required javascript code.
	 */
	public static String computeURL(PageContext in_pageContext, String in_forward, String in_url, String in_page, String in_action, String in_module, Map in_params, String in_anchor, boolean in_redirect, String in_target, String in_scheme) throws JspException {
	    if (noErrorMode) {
	        return "/dummyUrl.do";
	    }
