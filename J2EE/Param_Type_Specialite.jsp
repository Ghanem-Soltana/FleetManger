...
<head>
<title><bean:message key="spec.type" /></title>
</head>
...
<br/>
<b><bean:message key="spec.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_specialite.do?action=ajout">
	<lay:panel align="center" key="ajout.spec" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_spec"/>  </td>
				<td align="left"><html:text name="specialite" property="id_specialite" size="4" maxlength="3" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_spec"/>  </td>
				<td align="left"><html:text  name="specialite" property="libelle_specialite" size="20" maxlength="20"  styleId="lib"></html:text></td>
...
<html:form action="gestion_specialite.do?action=edit">
	<lay:panel align="center" key="edit.spec" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_spec"/>  </td>
				<td align="left"><html:text name="specialite" property="id_specialite" readonly="true" size="4" maxlength="3"  styleId="id"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_maint"/>  </td>
				<td align="left"><html:text name="specialite"  property="libelle_specialite" size="20" maxlength="20"  styleId="lib"></html:text></td>
			...
			<tr>
			    ...
			    <td><html:button  styleId="b1" onclick="document.location.href='gestion_specialite.do?action=all'" property="" > <bean:message key="annuler"/></html:button></td>
			    </tr>
			    </table>
			    </td>
			</tr>
...
<logic:present name="type_specialite" >
<lay:pager maxPageItems="20" > 
<lay:collection name="type_specialite" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_spec">
<lay:collectionItem  property="id_specialite"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_spec">
<lay:collectionItem    property="libelle_specialite" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_specialite.do?action=modif&id=" paramId="id" param="id_specialite"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_specialite"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_spec"/></td>
...
lien=SortUtil.getURLForCollection("id_specialite",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_specialite",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typspec"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libspec"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_specialite.do?action=supp&id='+document.getElementById('cd').value}
