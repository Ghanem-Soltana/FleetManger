...
<head>
<title><bean:message key="plan.type" /></title>
</head>
...
<br/>
<b><bean:message key="plan.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_plan.do?action=ajout">
<lay:panel align="center" key="edit.plan" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_plan"/>  </td>
				<td align="left"><html:text name="plan" property="id_plan" size="2" maxlength="2" styleId="id" onkeypress="return numeric(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_plan"/>  </td>
				<td align="left"><html:text  name="plan" property="libelle_plan" size="20" maxlength="20"  styleId="lib"></html:text></td>
...
<html:form action="gestion_plan.do?action=edit">
	<lay:panel align="center" key="edit.plan" styleClass="FORM">
			<tr>
				<td align="left"> <bean:message key="id_plan"/>  </td>
				<td align="left"><html:text name="plan" property="id_plan" readonly="true" size="2" maxlength="2"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<td>
				 ...
				 <html:button styleId="b1"  onclick="document.location.href='gestion_plan.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				 </td>
				 </tr>
				 </table>
				 </td>
...
<logic:present name="liste_plan" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_plan" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_plan">
<lay:collectionItem  property="id_plan"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_plan">
<lay:collectionItem    property="libelle_plan" ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionItem title=" " href="gestion_plan.do?action=modif&id=" paramId="id" param="id_plan"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_plan"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_plan"/></td>
...
lien=SortUtil.getURLForCollection("id_plan",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_plan",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typplan"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libplan"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_plan.do?action=supp&id='+document.getElementById('cd').value}
