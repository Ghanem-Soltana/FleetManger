...
<head>
<title><bean:message key="ville.type" /></title>
</head>
...
<br/>
<b><bean:message key="ville.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_ville.do?action=ajout">
<lay:panel align="center" key="edit.ville" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_ville"/>  </td>
				<td align="left"><html:text name="ville" property="id_ville" size="3" maxlength="3" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_ville"/>  </td>
				<td align="left"><html:text  name="ville" property="libelle_ville" size="50" maxlength="50"  styleId="lib"></html:text></td>
			...
			<tr>
				<td align="left"> <bean:message key="cp_ville"/>  </td>
				<td align="left"><html:text  name="ville" property="cp" size="6" maxlength="6"  styleId="cp" onkeypress="return numeric(event)"></html:text></td>
...
<html:form action="gestion_ville.do?action=edit">
	<lay:panel align="center" key="edit.ville" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_ville"/>  </td>
				<td align="left"><html:text name="ville" property="id_ville" readonly="true" size="3" maxlength="3"  styleId="id"></html:text></td>
		...
		<tr>
			...
			<tr>
				...
				<html:button  styleId="b1" onclick="document.location.href='gestion_ville.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
				</td>
...
<logic:present name="liste_ville" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_ville" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_ville">
<lay:collectionItem  property="id_ville"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_ville">
<lay:collectionItem    property="libelle_ville" ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="cp_ville_trie">
<lay:collectionItem    property="cp" ></lay:collectionItem>
</lay:collectionTitle>


<lay:collectionItem title=" " href="gestion_ville.do?action=modif&id=" paramId="id" param="id_ville"><img src="config/modif.png" alt="modifier" border="0"  /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_ville"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_ville"/></td>
    <td align="center"><input type="text" id="aff"  maxlength="3" style="border-width:0px;height:20px;width:40px;" onkeypress="return block()"/></td></tr>
	</table>
...
lien=SortUtil.getURLForCollection("id_ville",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_ville",request);
lien1=lien1.replace("amp;","")+nb_page;
lien2=SortUtil.getURLForCollection("cp",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typville"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libville"  />'+fin);
rouge('lib')
if(test==true)
...
if(cp=='')
{
$.jGrowl(image+'<bean:message key="java.cpville"  />'+fin);
rouge('cp')
if(test==true)
...
function supp2()
{window.location.href='gestion_ville.do?action=supp&id='+document.getElementById('cd').value}
