...
<head>
<title><bean:message key="fam_sec.type" /></title>
</head>
...
<br/>
<b><bean:message key="fam_sec.type" /></b>
<br/>
<br/>

<logic:notPresent name="listevide2">
<logic:notPresent name="x1"> 
<html:form action="fam_article_2.do?action=ajout" styleId="form1">
	<lay:panel align="center" key="ajout.fam_sec" styleClass="FORM">
		...
		<tr>
				...
				<td align="left"> <bean:message key="lib_fam_princ1"/> </td>
					<td align="left">
					<html:select property="id_famille_princi" name="fam_sec" styleId="select_fam_princi">
					<html:options collection="liste2" property="id_famille_princi"  name="liste2" labelProperty="libelle_famille_princi"/>
            		</html:select>
				</td>
			</tr>
			...
			<tr>
				<td align="left"> <bean:message key="id_fam_sec"/>  </td>
				<td align="left"><html:text name="fam_sec" property="id_famille_sec" size="5" maxlength="5" styleId="id" onkeypress="return alphanum(event)"></html:text></td>
			...
			<tr>
				...
				<td align="left"><html:text  name="fam_sec" property="libelle_famille_sec" size="30" maxlength="30"  styleId="lib"></html:text></td>
			</tr>
...
<html:form action="fam_article_2.do?action=edit" styleId="form1">
	<lay:panel align="center" key="edit.fam_sec" styleClass="FORM">
	
		
			<tr>
				<td align="left"> <bean:message key="lib_fam_princ1"/> </td>
					<td align="left">
					<html:select property="id_famille_princi" name="fam_sec">
					<html:options collection="liste2" property="id_famille_princi"  name="liste2" labelProperty="libelle_famille_princi"/>
            		</html:select>
				</td>
			</tr>
			...
			<tr>
				<td align="left"> <bean:message key="id_fam_sec"/>  </td>
				<td align="left"><html:text name="fam_sec" property="id_famille_sec" readonly="true" size="5" maxlength="5"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<html:button styleId="b1" onclick="document.location.href='fam_article_2.do?action=annul'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
				</td>
...
<logic:present name="listevide2"><b><font color="red"><bean:message key="er_liste_vide2"/></font></b><br/><br/></logic:present>
...
<center>
<logic:notPresent name="listevide2">
	<html:form action="fam_article_2.do?action=select" styleId="form">	
	<table border="0"><tr>
				<td><bean:message key="afficher_sec"/></td>
		        <td width="190px">
					<html:select property="id_famille_princi" name="vider" onchange="agaga()" styleId="select">
					<html:options collection="liste3" property="id_famille_princi"  name="liste3" labelProperty="libelle_famille_princi"/>
            		</html:select>
			   </td>
			</tr>
</table></html:form>
...
<logic:present name="liste_fam_sec" >

<lay:pager maxPageItems="20" > 
<lay:collection name="liste_fam_sec" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_fam_sec">
<lay:collectionItem  property="id_famille_sec"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_fam_sec">
<lay:collectionItem    property="libelle_famille_sec" ></lay:collectionItem>
</lay:collectionTitle>


<lay:collectionTitle title="libelle_fam_princ1">
...
<lay:collectionItem title=" " href="fam_article_2.do?action=modif&id=" paramId="id" param="id_famille_sec"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_famille_sec"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_fam_sec"/></td>
...
<%
String lien="",lien1="",lien2="",nb_page="",sms="";
...
lien=SortUtil.getURLForCollection("id_famille_sec",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_famille_sec",request);
lien1=lien1.replace("amp;","")+nb_page;
lien2=SortUtil.getURLForCollection("libelle_famille_princi",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typfam_sec"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libfam_sec"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='fam_article_2.do?action=supp&id='+document.getElementById('cd').value}
...
function envoie(id)
{
if(id=='id_fam_sec_lien')
document.location.href='<%=lien%>'
if(id=='lib_fam_sec_lien')
document.location.href='<%=lien1%>'
if(id=='princ_fam_sec_lien')
...
document.getElementById('form1').action='fam_article_2.do?action=select&id='+id
