...
<head>
<title><bean:message key="tiers.type" /></title>
</head>
...
<br/>
<b><bean:message key="tiers.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_type_tiers.do?action=ajout">
	<lay:panel align="center" key="ajout.tiers" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_tiers"/>  </td>
				<td align="left"><html:text name="tiers" property="id_tiers" size="2" maxlength="2" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_tiers"/>  </td>
				<td align="left"><html:text  name="tiers" property="libelle_tiers" size="50" maxlength="50"  styleId="lib"></html:text></td>
...
<html:form action="gestion_type_tiers.do?action=edit">
	<lay:panel align="center" key="edit.tiers" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_tiers"/>  </td>
				<td align="left"><html:text name="tiers" property="id_tiers" readonly="true" size="2" maxlength="2"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<html:button styleId="b1"  onclick="document.location.href='gestion_type_tiers.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
				</td>
...
<logic:present name="liste_tiers" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_tiers" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_tiers">
<lay:collectionItem  property="id_tiers"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_tiers">
<lay:collectionItem    property="libelle_tiers" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_type_tiers.do?action=modif&id=" paramId="id" param="id_tiers"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_tiers"/></td>
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typtiers"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libtiers"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_type_tiers.do?action=supp&id='+document.getElementById('cd').value}
