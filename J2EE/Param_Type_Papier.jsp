...
<head>
<title><bean:message key="papier.type" /></title>
</head>
...
<br/>
<b><bean:message key="papier.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_papier.do?action=ajout">
	<lay:panel align="center" key="ajout.papier" styleClass="FORM">

			<tr>
				<td align="left"> <bean:message key="id_papier"/>  </td>
				<td align="left"><html:text name="papier" property="id_papier" size="2" maxlength="2" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_papier"/>  </td>
				<td align="left"><html:text  name="papier" property="libelle_papier" size="50" maxlength="50"  styleId="lib"></html:text></td>
...
<html:form action="gestion_papier.do?action=edit">
	<lay:panel align="center" key="edit.papier" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_papier"/>  </td>
				<td align="left"><html:text name="papier" property="id_papier" readonly="true" size="2" maxlength="2"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<td>
				 ...
				 <html:button styleId="b1"  onclick="document.location.href='gestion_papier.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				 </td>
				 </tr></table>
				 </td>
...
<logic:present name="liste_papier" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_papier" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_papier">
<lay:collectionItem  property="id_papier"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_papier">
<lay:collectionItem    property="libelle_papier" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_papier.do?action=modif&id=" paramId="id" param="id_papier"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_papier"></bean:define>
...
lien=SortUtil.getURLForCollection("id_papier",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_papier",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typpapier"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libpapier"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_papier.do?action=supp&id='+document.getElementById('cd').value}
...
function envoie(id)
{
if(id=='id_papier_lien')
document.location.href='<%=lien%>'
if(id=='lib_papier_lien')
