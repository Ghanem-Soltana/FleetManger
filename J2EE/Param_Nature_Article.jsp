...
<head>
<title><bean:message key="article.type" /></title>
</head>
...
<br/>
<b><bean:message key="article.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_article.do?action=ajout">
	<lay:panel align="center" key="ajout.article" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_article"/>  </td>
				<td align="left"><html:text name="article" property="id_article" size="2" maxlength="2" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_article"/>  </td>
				<td align="left"><html:text  name="article" property="libelle_article" size="20" maxlength="20"  styleId="lib"></html:text></td>
...
<html:form action="gestion_article.do?action=edit">
	<lay:panel align="center" key="edit.article" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_article"/>  </td>
				<td align="left"><html:text name="article" property="id_article" readonly="true" size="2" maxlength="2"  styleId="id" ></html:text></td>
			...
			<tr>
				...
				<html:button styleId="b1" onclick="document.location.href='gestion_article.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
				</td>
...
<logic:present name="liste_article" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_article" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_article">
<lay:collectionItem  property="id_article"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_article">
<lay:collectionItem    property="libelle_article" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_article.do?action=modif&id=" paramId="id" param="id_article"><img src="config/modif.png" alt="modifier" border="0" ></lay:collectionItem>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_article"/></td>
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typarticle"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libarticle"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_article.do?action=supp&id='+document.getElementById('cd').value}
