...
<head>
<title><bean:message key="type_bon.type" /></title>
</head>
...
<br/>
<b><bean:message key="type_bon.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_type_bon.do?action=ajout">
	<lay:panel align="center" key="ajout.type_bon" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_type_bon"/>  </td>
				<td align="left"><html:text name="type_bon" property="id_bon" size="2" maxlength="2" styleId="id" onkeypress="return numeric(event,'id')"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_type_bon"/>  </td>
				<td align="left"><html:text  name="type_bon" property="libelle_bon" size="50" maxlength="50"  styleId="lib"></html:text></td>
					...
					<tr>
				<td align="left"> <bean:message key="qte_type_bon"/>  </td>
				<td align="left"><html:text name="type_bon" property="qte_bon" size="13" maxlength="13" styleId="qte" onkeypress="return numeric(event,'qte')"></html:text></td>

		
			</tr>
			
					<tr>
				<td align="left"> <bean:message key="valeur_type_bon"/>  </td>
				<td align="left"><html:text name="type_bon" property="valeur_bon" size="13" maxlength="13" styleId="valeur" onkeypress="return numeric(event,'valeur')"></html:text></td>
...
<html:form action="gestion_type_bon.do?action=edit">
	<lay:panel align="center" key="edit.type_bon" styleClass="FORM">
	
	<tr>
				<td align="left"> <bean:message key="id_type_bon"/>  </td>
				<td align="left"><html:text readonly="true" name="type_bon" property="id_bon" size="2" maxlength="2" styleId="id" onkeypress="return numeric(event,'id')"></html:text></td>
			...
			<tr>
				...
				<td><html:button  onclick="document.location.href='gestion_type_bon.do?action=all'" property="" styleId="b1" > <bean:message key="annuler"/></html:button>
			    </td>
			   </tr></table>
...
<logic:present name="type_type_bon" >



<lay:pager maxPageItems="20"  > 
<lay:collection name="type_type_bon" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_type_bon">
<lay:collectionItem  property="id_bon"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_type_bon">
<lay:collectionItem    property="libelle_bon" ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="qte_type_bon_aff">
<lay:collectionItem    property="qte_bon" ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="valeur_type_bon_aff">
<lay:collectionItem    property="valeur_bon" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_type_bon.do?action=modif&id=" paramId="id" param="id_bon"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_type_bon"/></td>
...
lien1=SortUtil.getURLForCollection("libelle_bon",request);
lien1=lien1.replace("amp;","")+nb_page;
lien2=SortUtil.getURLForCollection("qte_bon",request);
lien2=lien2.replace("amp;","")+nb_page;
lien3=SortUtil.getURLForCollection("valeur_bon",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typtype_bon"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libtype_bon"  />'+fin);
rouge('lib')
if(test==true)
...
if(qte=='')
{
$.jGrowl(image+'<bean:message key="java.qtetype_bon"  />'+fin);
rouge('qte')
if(test==true)
window.document.getElementById('qte').focus()
test=false
}
...
if(valeur=='')
{
$.jGrowl(image+'<bean:message key="java.valeurtype_bon"  />'+fin);
rouge('valeur')
if(test==true)
window.document.getElementById('valeur').focus()
test=false
}
...
function supp2()
{window.location.href='gestion_type_bon.do?action=supp&id='+document.getElementById('cd').value}
...
function envoie(id)
{
if(id=='id_type_bon_lien')
document.location.href='<%=lien%>'
if(id=='lib_type_bon_lien')
document.location.href='<%=lien1%>'
if(id=='qte_type_bon_lien')
document.location.href='<%=lien2%>'
if(id=='valeur_type_bon_lien')
