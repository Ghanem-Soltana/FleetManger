...
<head>
<title><bean:message key="natarticle.type" /></title>
</head>
...
<br/>
<b><bean:message key="natarticle.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="type_article.do?action=ajout">
	<lay:panel align="center" key="ajout.natarticle" styleClass="FORM">

			<tr>
				<td align="left"> <bean:message key="id_natarticle"/>  </td>
				<td align="left"><html:text name="natarticle" property="id_natarticle" size="2" maxlength="2" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_natarticle"/>  </td>
				<td align="left"><html:text  name="natarticle" property="libelle_natarticle" size="20" maxlength="20"  styleId="lib"></html:text></td>
...
<html:form action="type_article.do?action=edit">
	<lay:panel align="center" key="edit.natarticle" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_natarticle"/>  </td>
				<td align="left"><html:text name="natarticle" property="id_natarticle" readonly="true" size="2" maxlength="2"  styleId="id" ></html:text></td>
			...
			<tr>
				...
				<td>
				 ...
				 <html:button styleId="b1" onclick="document.location.href='type_article.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
				 </td>
...
<logic:present name="liste_natarticle" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_natarticle" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_natarticle">
<lay:collectionItem  property="id_natarticle"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_natarticle">
<lay:collectionItem    property="libelle_natarticle" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="type_article.do?action=modif&id=" paramId="id" param="id_natarticle"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_natarticle"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_natarticle"/></td>
...
lien=SortUtil.getURLForCollection("id_natarticle",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_natarticle",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typnatarticle"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libnatarticle"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='type_article.do?action=supp1&id='+document.getElementById('cd').value}
...
function envoie(id)
{
if(id=='id_natarticle_lien')
document.location.href='<%=lien%>'
if(id=='lib_natarticle_lien')
