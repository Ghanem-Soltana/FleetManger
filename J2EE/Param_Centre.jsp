...
<head>
<title><bean:message key="centre.type" /></title>
</head>
...
<br/>
<b><bean:message key="centre.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_centre.do?action=ajout">
	<lay:panel align="center" key="ajout.centre" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_centre"/>  </td>
				<td align="left"><html:text name="centre" property="id_centre" size="2" maxlength="2" styleId="id" onkeypress="return numeric(event)"></html:text></td>
			...
			<tr>
				...
				<td align="left"><html:text  name="centre" property="libelle_centre" size="50" maxlength="50"  styleId="lib"></html:text></td>
		
			</tr>
			
			<tr>
				<td align="left"> <bean:message key="remarque_centre"/> </td>
				<td align="left"><html:text  name="centre" property="remarque_centre" size="50" maxlength="50"  styleId="rem"></html:text></td>
...
<html:form action="gestion_centre.do?action=edit">
	<lay:panel align="center" key="edit.centre" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_centre"/>  </td>
				<td align="left"><html:text name="centre" property="id_centre" readonly="true" size="2" maxlength="2"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<tr>
				<td>
				<html:submit indexed="b1" styleId="b1" onclick="return nonvide();"  > <bean:message key="modif"/></html:submit>
				</td><td>
				<html:button styleId="b1" onclick="document.location.href='gestion_centre.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
...
<logic:present name="liste_centre" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_centre" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_centre">
<lay:collectionItem  property="id_centre"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_centre">
<lay:collectionItem    property="libelle_centre" ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="remarque_centre1">
<lay:collectionItem    property="remarque_centre" ></lay:collectionItem>
</lay:collectionTitle>


<lay:collectionItem title=" " href="gestion_centre.do?action=modif&id=" paramId="id" param="id_centre"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_centre"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_centre"/></td>
...
lien=SortUtil.getURLForCollection("id_centre",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typcentre"  />'+fin);
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libcentre"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_centre.do?action=supp&id='+document.getElementById('cd').value}
...
function envoie(id)
{
if(id=='id_centre_lien')
document.location.href='<%=lien%>'
if(id=='lib_centre_lien')
