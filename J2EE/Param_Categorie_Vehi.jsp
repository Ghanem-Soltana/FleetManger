...
<head>
<title><bean:message key="categovehi.type" /></title>
</head>
...
<br/>
<b><bean:message key="categovehi.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_catego_vehi.do?action=ajout">
	<lay:panel align="center" key="ajout.categovehi" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_categovehi"/>  </td>
				<td align="left"><html:text name="categovehi" property="id_categovehi" size="3" maxlength="3" styleId="id" onkeypress="return alphanum(event,'id')"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_categovehi"/>  </td>
				<td align="left"><html:text  name="categovehi" property="libelle_categovehi" size="60" maxlength="60"  styleId="lib"></html:text></td>
						...
						<tr>
				<td align="left"> <bean:message key="nbr_categovehi"/>  </td>
				<td align="left"><html:text  name="categovehi" property="nbr_place" size="3" maxlength="3" onkeypress="return numeric(event,'nb')"  styleId="nb"></html:text></td>
...
<html:form action="gestion_catego_vehi.do?action=edit">
	<lay:panel align="center" key="edit.categovehi" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_categovehi"/>  </td>
				<td align="left"><html:text name="categovehi" property="id_categovehi" readonly="true" size="3" maxlength="3"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<table border="0">
				<tr>
				<td> <html:submit indexed="b1" styleId="b1" onclick="return nonvide();"  > <bean:message key="modif"/></html:submit></td>
			    <td><html:button indexed="b1" styleId="b1"  onclick="document.location.href='gestion_catego_vehi.do?action=all'" property="" > <bean:message key="annuler"/></html:button></td>
			  </tr></table>
			      </td>
...
<logic:present name="liste_categovehi" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_categovehi" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_categovehi">
<lay:collectionItem  property="id_categovehi"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_categovehi">
<lay:collectionItem    property="libelle_categovehi" ></lay:collectionItem>
</lay:collectionTitle>


<lay:collectionTitle title="nbrplace_categovehi">
<lay:collectionItem    property="nbr_place" ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionItem title=" " href="gestion_catego_vehi.do?action=modif&id=" paramId="id" param="id_categovehi"><img src="config/modif.png" alt="modifier" border="0"  /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_categovehi"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_categovehi"/></td>
...
lien=SortUtil.getURLForCollection("id_categovehi",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_categovehi",request);
lien1=lien1.replace("amp;","")+nb_page;

lien2=SortUtil.getURLForCollection("nbr_place",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typcategovehi"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libcategovehi"  />'+fin);
rouge('lib')
if(test==true)
...
if(nb=='')
{
$.jGrowl(image+'<bean:message key="java.nbcategovehi"  />'+fin);
rouge('nb')
if(test==true)
window.document.getElementById('nb').focus()
test=false
}
return test
...
function supp2()
{window.location.href='gestion_catego_vehi.do?action=supp&id='+document.getElementById('cd').value}
...
function envoie(id)
{
if(id=='id_categovehi_lien')
document.location.href='<%=lien%>'
if(id=='lib_categovehi_lien')
document.location.href='<%=lien1%>'
if(id=='nbrplace_categovehi_lien')
