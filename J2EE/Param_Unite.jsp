...
<head>
<title><bean:message key="unite.type" /></title>
</head>
...
<br/>
<b><bean:message key="unite.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_unite.do?action=ajout">
	<lay:panel align="center" key="ajout.unite" styleClass="FORM">

			<tr>
				<td align="left"> <bean:message key="id_unite"/>  </td>
				<td align="left"><html:text name="unite" property="id_unite" size="3" maxlength="3" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_unite"/>  </td>
				<td align="left"><html:text  name="unite" property="libelle_unite" size="20" maxlength="20"  styleId="lib"></html:text></td>
			
			</tr>
						<tr>
				<td align="left"> <bean:message key="dec_unite"/>  </td>
				<td align="left"><html:text  name="unite" property="decimale" size="1" maxlength="1"  styleId="dec" onkeypress="return numeric(event)"></html:text></td>
...
<html:form action="gestion_unite.do?action=edit">
	<lay:panel align="center" key="edit.unite" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_unite"/>  </td>
				<td align="left"><html:text name="unite" property="id_unite" readonly="true" size="3" maxlength="3"  styleId="id"></html:text></td>
		...
		<tr>
			...
			<tr>
				...
				<html:button styleId="b1"  onclick="document.location.href='gestion_unite.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
				</td>
...
<logic:present name="liste_unite" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_unite" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_unite">
<lay:collectionItem  property="id_unite"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_unite">
<lay:collectionItem    property="libelle_unite" ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="decimale_unite">
<lay:collectionItem    property="decimale" ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionItem title=" " href="gestion_unite.do?action=modif&id=" paramId="id" param="id_unite"><img src="config/modif.png" alt="modifier" border="0"  /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_unite"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_unite"/></td>
...
lien=SortUtil.getURLForCollection("id_unite",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_unite",request);
lien1=lien1.replace("amp;","")+nb_page;
lien2=SortUtil.getURLForCollection("decimale",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typunite"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libunite"  />'+fin);
if(test==true)
window.document.getElementById('lib').focus()
rouge('lib')
test=false
...
if(dec=='')
{
$.jGrowl(image+'<bean:message key="java.decunite"  />'+fin);
rouge('dec')
if(test==true)
window.document.getElementById('dec').focus()
test=false
}
return test
...
function supp2()
{window.location.href='gestion_unite.do?action=supp&id='+document.getElementById('cd').value}
...
if(id=='lib_unite_lien')
document.location.href='<%=lien1%>'
if(id=='dec_unite_lien')
