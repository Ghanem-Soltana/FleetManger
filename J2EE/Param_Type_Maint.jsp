...
<head>
<title><bean:message key="maint.type" /></title>
</head>
...
<br/>
<b><bean:message key="maint.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_maint.do?action=ajout">
	<lay:panel align="center" key="ajout.maint" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_maint"/>  </td>
				<td align="left"><html:text name="maintenance" property="id_maint" size="3" maxlength="3" styleId="id" onkeypress="return alphanum(event)"></html:text></td>
			...
			<tr>
				...
				<td align="left"><html:text  name="maintenance" property="libelle_maint" size="30" maxlength="30"  styleId="lib"></html:text></td>
			...
			<tr>
				<td></td>
				<td> <html:submit styleId="b1" indexed="b1"  styleId="b1" onclick="return nonvide()"  > <bean:message key="ajout"/></html:submit></td>
			    <td></td>
			</tr>
...
<html:form action="gestion_maint.do?action=edit">
	<lay:panel align="center" key="edit.maint" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_maint"/>  </td>
				<td align="left"><html:text name="maintenance" property="id_maint" readonly="true" size="3" maxlength="3"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<td><html:button  onclick="document.location.href='gestion_maint.do?action=all'" property="" styleId="b1" > <bean:message key="annuler"/></html:button>
			    </td>
			   </tr></table>
...
<logic:present name="type_maint" >



<lay:pager maxPageItems="20"  > 
<lay:collection name="type_maint" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code">
<lay:collectionItem  property="id_maint"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle">
<lay:collectionItem    property="libelle_maint" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_maint.do?action=modif&id=" paramId="id" param="id_maint"><img src="config/modif.png" alt="modifier" border="0"  /></lay:collectionItem>
...
<bean:define id="temp" name="ji" property="id_maint"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_maint"/></td>
...
lien=SortUtil.getURLForCollection("id_maint",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_maint",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typmaint"  />'+fin);
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libmaint"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_maint.do?action=supp&id='+document.getElementById('cd').value}
