...
<br/>
<b><bean:message key="marq.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_marque.do?action=ajout">
	<lay:panel align="center" key="ajout.marq" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_marq"/>  </td>
				<td align="left"><html:text name="marque" property="id_marque" size="5" maxlength="5" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_marq"/>  </td>
				<td align="left"><html:text  name="marque" property="libelle_marque" size="30" maxlength="30"  styleId="lib"></html:text></td>
...
<html:form action="gestion_marque.do?action=edit">
	<lay:panel align="center" key="edit.marq" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_marq"/>  </td>
				<td align="left"><html:text name="marque" property="id_marque" readonly="true" size="5" maxlength="5"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<td>
				 ...
				 <html:button styleId="b1"  onclick="document.location.href='gestion_marque.do?action=all'" property="id_marq" > <bean:message key="annuler"/></html:button>
				 </td>
				 </tr>
				 </table>
...
<logic:present name="liste_marque" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_marque" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_marq">
<lay:collectionItem  property="id_marque"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_marq">
<lay:collectionItem    property="libelle_marque" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_marque.do?action=modif&id=" paramId="id" param="id_marque"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_marque"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_marq"/></td>
...
lien=SortUtil.getURLForCollection("id_marque",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_marque",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typmarq"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libmarq"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_marque.do?action=supp&id='+document.getElementById('cd').value}
