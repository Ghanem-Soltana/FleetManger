...
<head>
<title><bean:message key="marq.type" /></title>
</head>
...
<br/>
<b><bean:message key="quali.type" /></b>
<br/>
<br/>


<logic:notPresent name="x"> 
<html:form action="gestion_qualite.do?action=ajout">
	<lay:panel align="center" key="ajout.quali" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_quali"/>  </td>
				<td align="left"><html:text name="qualite" property="id_qualite" size="5" maxlength="5" styleId="id" onkeypress="return alphanum(event)"></html:text></td>
			...
			<tr>
				...
				<td align="left"><html:text  name="qualite" property="libelle_qualite" size="30" maxlength="30"  styleId="lib"></html:text></td>
...
<html:form action="gestion_qualite.do?action=edit">
	<lay:panel align="center" key="edit.quali" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_quali"/>  </td>
				<td align="left"><html:text name="qualite" property="id_qualite" readonly="true" size="5" maxlength="5"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<html:button styleId="b1" onclick="document.location.href='gestion_qualite.do?action=all'" property="id_quali" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
				</td>
...
<logic:present name="liste_qualite" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_qualite" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_quali">
<lay:collectionItem  property="id_qualite"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_quali">
<lay:collectionItem    property="libelle_qualite" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_qualite.do?action=modif&id=" paramId="id" param="id_qualite"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_qualite"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_quali"/></td>
...
lien=SortUtil.getURLForCollection("id_qualite",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_qualite",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typquali"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libquali"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_qualite.do?action=supp&id='+document.getElementById('cd').value}
