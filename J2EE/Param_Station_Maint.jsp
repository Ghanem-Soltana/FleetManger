...
<head>
<title><bean:message key="stat.type" /></title>
</head>
...
<br/>
<b><bean:message key="stat.type" /></b>
<br/>
<br/>

<logic:notPresent name="x"> 
<html:form action="gestion_station_maint.do?action=ajout">
	<lay:panel align="center" key="ajout.maint" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_stat"/>  </td>
				<td align="left"><html:text name="station" property="id_station" size="2" maxlength="2" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_stat"/>  </td>
				<td align="left"><html:text  name="station" property="libelle_station" size="30" maxlength="30"  styleId="lib"></html:text></td>
...
<html:form action="gestion_station_maint.do?action=edit">
	<lay:panel align="center" key="edit.stat" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_stat"/>  </td>
				<td align="left"><html:text name="station" property="id_station" readonly="true" size="2" maxlength="2"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<html:button styleId="b1"  onclick="document.location.href='gestion_station_maint.do?action=all'" property="" >  <bean:message key="annuler"/></html:button></td>
			  </tr>
			   </table>
			   </td>
			</tr>
...
<logic:present name="liste_station" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_station" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_stat">
<lay:collectionItem  property="id_station"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_stat">
<lay:collectionItem    property="libelle_station" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_station_maint.do?action=modif&id=" paramId="id" param="id_station"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_station"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_stat"/></td>
...
lien=SortUtil.getURLForCollection("id_station",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_station",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typstat"  />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libstat"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_station_maint.do?action=supp&id='+document.getElementById('cd').value}
