...
<head>
<title><bean:message key="motif.type" /></title>
</head>
...
<br/>
<b><bean:message key="motif.type" /></b>
<br/>
<br/>
...
<html:form action="gestion_motif.do?action=ajout">
	<lay:panel align="center" key="ajout.motif" styleClass="FORM">
		
			<tr>
				<td align="left"> <bean:message key="id_motif"/>  </td>
				<td align="left"><html:text name="motif" property="id_motif" size="2" maxlength="2" styleId="id" onkeypress="return alphanum(event)"></html:text></td>

		
			</tr>

			<tr>
				<td align="left"> <bean:message key="lib_motif"/>  </td>
				<td align="left"><html:text  name="motif" property="libelle_motif" size="50" maxlength="50"  styleId="lib"></html:text></td>
...
<html:form action="gestion_motif.do?action=edit">
	<lay:panel align="center" key="edit.motif" styleClass="FORM">
	
			<tr>
				<td align="left"> <bean:message key="id_motif"/>  </td>
				<td align="left"><html:text name="motif" property="id_motif" readonly="true" size="2" maxlength="2"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<html:button styleId="b1" onclick="document.location.href='gestion_motif.do?action=all'" property="" > <bean:message key="annuler"/></html:button>
				</td>
				</tr>
				</table>
				</td>
...
<logic:present name="liste_motif" >
<lay:pager maxPageItems="20" > 
<lay:collection name="liste_motif" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_motif">
<lay:collectionItem  property="id_motif"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_motif">
<lay:collectionItem    property="libelle_motif" ></lay:collectionItem>
</lay:collectionTitle>



<lay:collectionItem title=" " href="gestion_motif.do?action=modif&id=" paramId="id" param="id_motif"><img src="config/modif.png" alt="modifier" border="0"  /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_motif"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_motif"/></td>
...
lien=SortUtil.getURLForCollection("id_motif",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_motif",request);
...
if(id=='')
{test=false
 $.jGrowl(image+'<bean:message key="java.typmotif" />'+fin);
 rouge('id')
...
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libmotif"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_motif.do?action=supp&id='+document.getElementById('cd').value}
