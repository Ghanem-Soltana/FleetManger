...
<head>
<title><bean:message key="agence.type" /></title>
</head>
...
<br/>
<b><bean:message key="agence.type" /></b>
<br/>
<br/>

<logic:notPresent name="listevide2">
<logic:notPresent name="x1"> 
<html:form action="gestion_agence.do?action=ajout">
	<lay:panel align="center" key="ajout.agence" styleClass="FORM">
		...
		<tr>
				...
				<td align="left"> <bean:message key="lib_centre"/> </td>
					<td align="left">
					<html:select property="id_centre" name="agence">
			...
			<tr>
				<td align="left"> <bean:message key="id_agence"/>  </td>
				<td align="left"><html:text name="agence" property="id_agence" size="5" maxlength="5" styleId="id" onkeypress="return numeric(event)"></html:text></td>
			...
			<tr>
				...
				<td align="left"><html:text  name="agence" property="libelle_agence" size="50" maxlength="50"  styleId="lib"></html:text></td>
			</tr>
...
<html:form action="gestion_agence.do?action=edit">
	<lay:panel align="center" key="edit.agence" styleClass="FORM">
			...
			<tr>
				<td align="left"> <bean:message key="id_agence"/>  </td>
				<td align="left"><html:text name="agence" property="id_agence" readonly="true" size="5" maxlength="5"  styleId="id"></html:text></td>
			...
			<tr>
				...
				<td><html:button   onclick="document.location.href='gestion_agence.do?action=all'" property="" styleId="b1" > <bean:message key="annuler"/></html:button>
			    </td>
			   </tr></table>
...
<logic:present name="listevide2"><b><font color="red"><bean:message key="er_liste_vide3"/></font></b><br/><br/></logic:present>
...
<center>
<logic:notPresent name="listevide2">
	<html:form action="gestion_agence.do?action=select" styleId="form">	
	<table border="0"><tr>
				<td><bean:message key="afficher_agence"/></td>
		        <td width="200px">
					<html:select property="id_centre" name="vider" onchange="agaga()" styleId="select">
...
<logic:present name="liste_agence" >

<lay:pager maxPageItems="20" > 
<lay:collection name="liste_agence" id="ji"  styleClass="FORM" styleClass2="FORM2" >

<lay:collectionTitle title="code_agence">
<lay:collectionItem  property="id_agence"  ></lay:collectionItem>
</lay:collectionTitle>

<lay:collectionTitle title="libelle_agence">
<lay:collectionItem    property="libelle_agence" ></lay:collectionItem>
</lay:collectionTitle>


<lay:collectionTitle title="libelle_centre1">
...
<lay:collectionItem title=" " href="gestion_agence.do?action=modif&id=" paramId="id" param="id_agence"><img src="config/modif.png" alt="modifier" border="0" /></lay:collectionItem>
<lay:collectionItem title=" ">
<bean:define id="temp" name="ji" property="id_agence"></bean:define>
...
<lay:popup key="java_confirm_titre" styleClass="FORM3" styleId="popup">
	...
	<table border="0" ><tr><td><lay:message key="java_supp_confirm_agence"/></td>
...
lien=SortUtil.getURLForCollection("id_agence",request);
lien=lien.replace("amp;","")+nb_page;
lien1=SortUtil.getURLForCollection("libelle_agence",request);
...
{test=false
rouge('id')
 $.jGrowl(image+'<bean:message key="java.typagence"  />'+fin);
window.document.getElementById('id').focus()
}
lib=document.getElementById('lib').value
if(lib=='')
{
$.jGrowl(image+'<bean:message key="java.libagence"  />'+fin);
rouge('lib')
if(test==true)
...
function supp2()
{window.location.href='gestion_agence.do?action=supp&id='+document.getElementById('cd').value}
...
function envoie(id)
{
if(id=='id_agence_lien')
document.location.href='<%=lien%>'
if(id=='lib_agence_lien')
...
if(id==null||id=='')
id='xxxxxx'
document.getElementById('form').action='gestion_agence.do?action=select&id='+id
