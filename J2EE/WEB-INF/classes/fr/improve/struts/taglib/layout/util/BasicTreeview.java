...
public class BasicTreeview implements TreeviewInterface {
	 ...
	 */
	protected void renderLabel(StringBuffer buffer, HttpServletRequest in_request, ServletContext in_servletcontext, String in_bundle, String key) throws JspException {
